...
class CurvedWidget extends StatelessWidget {
  ...
  const CurvedWidget({Key key, this.curvedDistance = 80.0, this.curvedHeight = 80.0, this.child}) : super(key: key);
...
class CurvedWidgetBackgroundClipper extends CustomClipper<Path> {
  ...
  getClip(Size size) {
    ...
    clippedPath.quadraticBezierTo(0.0, size.height - curvedHeight, 0.0, size.height);
    clippedPath.lineTo(0.0, 0.0);
    return clippedPath;
  }
